...
<form method="POST"  action="actions/salvar.php">
    ...
    <div class="row mb-3">
        ...
        <div class="col-md-2">
            ...
            <input type="tel" required class="form-control" id="telefone" name="nome" value="<?= $c['telefone'] ?>">
        </div>
        ...
        <?php
            ...
            foreach ($capitalDAO->buscarTodos() as $capital) {
                ...
                if ($capital['id'] == $c['capital_id']) {
                    ...
                    echo "<input class=\"form-check-input\" type=\"radio\" name=\"capital_id\"
                    id=\"radioCapital-{$capital['id']}\" value=\"{$capital['id']}\">";
                }
                echo "
            ...
            <div class="mb-2">
                ...
                <select name="tempo_experiencia_id" class="form-control" id="tempoExperiencia">
                    <?php
                        ...
                        foreach($TempoDeExperienciaDAO->buscarTodos() as $te) {
    ...
    <div class="row mb-3">
        <div class="col-12">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control" name="comentarios" id="comentarios" rows="3"><?= $c["comentarios"] ?></textarea>
